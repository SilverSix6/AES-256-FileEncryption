...
public class Encrypt {
    ...
    public static final int[][] S_BOX = {
        ...
        {0x53, 0xD1, 0x00, 0xED, 0x20, 0xFC, 0xB1, 0x5B, 0x6A, 0xCB, 0xBE, 0x39, 0x4A, 0x4C, 0x59, 0xCF},
        ...
        {0x8C, 0xA1, 0x89, 0x0D, 0xBF, 0xE6, 0x42, 0x68, 0x42, 0x99, 0x2D, 0x0F, 0xB0, 0x54, 0xBB, 0x16}
    };
    ...
    private static void Iteration(byte[] state, byte[] expandedKey){
        ByteSub(state);
        ShiftRow(state);
        MixColumn(state);
        AddRoundKey(state, expandedKey);
    ...
    private static void FinalIteration(byte[] state, byte[] expandedKey){
        ByteSub(state);
        ShiftRow(state);
        AddRoundKey(state, expandedKey);
    }
    ...
    static void AddRoundKey(byte[] state, byte[] expandedKey) {
    }
}
